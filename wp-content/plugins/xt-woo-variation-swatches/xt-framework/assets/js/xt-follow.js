;( function( window ) {
    ...
    XT_FOLLOW.init = function(accounts, exclude, selector) {
        ...
        var cssLink = document.getElementById('link[id="xt-follow"]');

        if(!cssLink) {
            var link = document.createElement('link');
            link.id = 'xt-follow';
            link.href = document.location.protocol+'//xplodedthemes.s3.amazonaws.com/widgets/xt-follow/css/xt-follow.css';
            link.type = 'text/css';
            link.rel = 'stylesheet';
